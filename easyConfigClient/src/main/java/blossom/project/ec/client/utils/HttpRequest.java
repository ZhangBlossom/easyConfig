...
public class HttpRequest {
     ...
     */
    public static void setConnectionFactory(final HttpRequest.ConnectionFactory connectionFactory) {
    ...
    public static class RequestOutputStream extends BufferedOutputStream {
         ...
         * @throws IOException
         */
        public HttpRequest.RequestOutputStream write(final String value) throws IOException {
     ...
     * @throws HttpRequest.HttpRequestException
     */
    public static HttpRequest post(final URL url) throws HttpRequest.HttpRequestException {
        return new HttpRequest(url, METHOD_POST);
    }
     ...
     * @throws HttpRequest.HttpRequestException
     */
    public static HttpRequest put(final URL url) throws HttpRequest.HttpRequestException {
        return new HttpRequest(url, METHOD_PUT);
    }
     ...
     * @throws HttpRequest.HttpRequestException
     */
    public static HttpRequest delete(final URL url) throws HttpRequest.HttpRequestException {
        return new HttpRequest(url, METHOD_DELETE);
    }
     ...
     * @throws HttpRequest.HttpRequestException
     */
    public static HttpRequest head(final URL url) throws HttpRequest.HttpRequestException {
        return new HttpRequest(url, METHOD_HEAD);
    }
     ...
     * @throws HttpRequest.HttpRequestException
     */
    public static HttpRequest options(final URL url) throws HttpRequest.HttpRequestException {
        return new HttpRequest(url, METHOD_OPTIONS);
    }
     ...
     * @throws HttpRequest.HttpRequestException
     */
    public static HttpRequest trace(final URL url) throws HttpRequest.HttpRequestException {
        return new HttpRequest(url, METHOD_TRACE);
    }
    ...
    private HttpRequest.UploadProgress progress = HttpRequest.UploadProgress.DEFAULT;
     ...
     * @throws HttpRequest.HttpRequestException
     */
    public String body(final String charset) throws HttpRequest.HttpRequestException {
     ...
     * @throws HttpRequest.HttpRequestException
     */
    public HttpRequest body(final AtomicReference<String> output) throws HttpRequest.HttpRequestException {
        output.set(body());
        return this;
    }
     ...
     * @throws HttpRequest.HttpRequestException
     */
    public HttpRequest body(final AtomicReference<String> output, final String charset) throws HttpRequest.HttpRequestException {
     ...
     * @throws HttpRequest.HttpRequestException
     */
    public HttpRequest receive(final File file) throws HttpRequest.HttpRequestException {
        ...
        return new HttpRequest.CloseOperation<HttpRequest>(output, ignoreCloseExceptions) {
    ...
    public HttpRequest receive(final Appendable appendable)
        ...
        return new HttpRequest.CloseOperation<HttpRequest>(reader, ignoreCloseExceptions) {
     ...
     * @throws HttpRequest.HttpRequestException
     */
    public String header(final String name) throws HttpRequest.HttpRequestException {
        closeOutputQuietly();
     ...
     * @throws HttpRequest.HttpRequestException
     */
    public long dateHeader(final String name) throws HttpRequest.HttpRequestException {
     ...
     * @throws HttpRequest.HttpRequestException
     */
    public int intHeader(final String name) throws HttpRequest.HttpRequestException {
    ...
    public HttpRequest basic(final String name, final String password) {
        return authorization("Basic " + HttpRequest.Base64.encode(name + ':' + password));
    }
    ...
    public HttpRequest proxyBasic(final String name, final String password) {
        return proxyAuthorization("Basic " + HttpRequest.Base64.encode(name + ':' + password));
    }
     ...
     * @return this request
     */
    public HttpRequest progress(final HttpRequest.UploadProgress callback) {
        if (callback == null)
            progress = HttpRequest.UploadProgress.DEFAULT;
        else
            progress = callback;
        return this;
    }
    ...
    protected HttpRequest openOutput() throws IOException {
        ...
        output = new HttpRequest.RequestOutputStream(getConnection().getOutputStream(), charset,
                bufferSize);
        return this;
    }
    ...
    public HttpRequest part(final String name, final String filename,
                                                final String part) throws HttpRequest.HttpRequestException {
     ...
     */
    public HttpRequest part(final String name, final String filename,
                                                final String contentType, final String part) throws HttpRequest.HttpRequestException {
        try {
            startPart();
     ...
     */
    public HttpRequest part(final String name, final String filename,
                                                final Number part) throws HttpRequest.HttpRequestException {
     ...
     */
    public HttpRequest part(final String name, final String filename,
                                                final File part) throws HttpRequest.HttpRequestException {
        return part(name, filename, null, part);
    }
     ...
     */
    public HttpRequest part(final String name, final String filename,
                                                final String contentType, final File part) throws HttpRequest.HttpRequestException {
     ...
     * @throws HttpRequest.HttpRequestException
     */
    public HttpRequest send(final File input) throws HttpRequest.HttpRequestException {
        final InputStream stream;
        try {
     ...
     * @throws HttpRequest.HttpRequestException
     */
    public HttpRequest send(final byte[] input) throws HttpRequest.HttpRequestException {
        if (input != null)
            incrementTotalSize(input.length);
     ...
     * @throws HttpRequest.HttpRequestException
     */
    public HttpRequest send(final InputStream input) throws HttpRequest.HttpRequestException {
        try {
            openOutput();
            copy(input, output);
        } catch (IOException e) {
    ...
    public HttpRequest send(final Reader input) throws HttpRequest.HttpRequestException {
        ...
        return new HttpRequest.FlushOperation<HttpRequest>(writer) {
     ...
     * @throws HttpRequest.HttpRequestException
     */
    public HttpRequest send(final CharSequence value) throws HttpRequest.HttpRequestException {
        try {
            openOutput();
     ...
     * @throws HttpRequest.HttpRequestException
     */
    public HttpRequest form(final Map<?, ?> values) throws HttpRequest.HttpRequestException {
     ...
     * @throws HttpRequest.HttpRequestException
     */
    public HttpRequest form(final Map.Entry<?, ?> entry) throws HttpRequest.HttpRequestException {
